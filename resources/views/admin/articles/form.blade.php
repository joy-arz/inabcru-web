...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function insertYoutubeButton(editorSelector, quillInstance) {
        var editorContainer = document.querySelector(editorSelector);
        if (!editorContainer) return;
        var toolbar = editorContainer.previousElementSibling;
    ...
    insertYoutubeButton('#editor_id', quillId);
    insertYoutubeButton('#editor_en', quillEn);
