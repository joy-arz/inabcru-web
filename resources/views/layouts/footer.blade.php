    ...
    <div class="grid md:grid-cols-4 gap-12 mb-12">
      <div>
        <a href="/{{ $locale }}" class="flex items-center gap-3 mb-4">
          <img src="{{ $siteImages['logo_dark']->image_url ?? '/images/Logo/InaBCRU_LOGO GELAP A.webp' }}" alt="{{ $siteImages['logo_dark']->alt_text ?? 'InaBCRU' }}" class="h-20 w-auto object-contain">
