        ...
        <aside id="sidebar" class="fixed top-0 left-0 z-40 h-screen bg-white border-r transition-all duration-300 w-64 flex flex-col">
            <div class="flex items-center h-16 px-4 border-b flex-shrink-0">
                <div class="flex items-center gap-3 overflow-hidden">
                    <img src="/images/Logo/InaBCRU_No Text.png" alt="InaBCRU" class="h-20 w-auto flex-shrink-0" style="object-fit: contain;">
            ...
            <nav class="flex-1 p-4 overflow-y-auto">
                <div class="space-y-1">
                    ...
                    <a href="{{ route('admin.publication-sections.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.publication-sections.*') ? 'bg-primary/10 text-primary font-medium' : 'text-gray-600 hover:bg-gray-100' }}">
                        <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                        </svg>
                        <span class="text-sm sidebar-text">Publication Sections</span>
                    </a>
                    ...
                    <a href="{{ route('admin.divisions.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.divisions.*') ? 'bg-primary/10 text-primary font-medium' : 'text-gray-600 hover:bg-gray-100' }}">
                        <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                        </svg>
                        <span class="text-sm sidebar-text">Divisions</span>
                    </a>
                    <a href="{{ route('admin.programs.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.programs.*') ? 'bg-primary/10 text-primary font-medium' : 'text-gray-600 hover:bg-gray-100' }}">
                        <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path>
                        </svg>
                        <span class="text-sm sidebar-text">Programs</span>
                    </a>
