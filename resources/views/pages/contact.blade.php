    ...
    <div class="grid lg:grid-cols-2 gap-12 lg:gap-16">
      <div class="animate-fade-up opacity-0">
        ...
        <form action="https://api.web3forms.com/submit" method="POST" class="space-y-6">
          <input type="hidden" name="access_key" value="b85e705f-6ca9-4f6d-8faa-e8c6b10ce98b">
          <input type="hidden" name="subject" value="{{ trans_for('contact.subject', $locale) }}">
          <div>
          ...
          <button type="submit" class="w-full px-6 py-3 bg-primary text-white font-semibold rounded-xl hover:bg-primary/90 transition-colors duration-200 cursor-pointer">
      ...
      <div class="animate-fade-up opacity-0" style="animation-delay: 0.2s;">
        ...
        <div class="mt-8">
          ...
          <div class="flex gap-3">
            <a href="https://www.instagram.com/inabcru" target="_blank" class="w-11 h-11 rounded-xl bg-surface-warm flex items-center justify-center text-primary border border-border hover:border-primary/30 hover:bg-primary/5 transition-all cursor-pointer">
